...
+ (void)load {
    ...
    dispatch_once(&onceToken, ^{
        ...
        NSString *tmpReplaceRangeOfStr = @"stringByReplacingCharactersInRange:withString:";
        NSString *tmpSafeReplaceRangeOfStr = @"safe_stringByReplacingCharactersInRange:withString:";
        NSString *tmpSafePointReplaceRangeOfStr = @"safePoint_stringByReplacingCharactersInRange:withString:";
        ...
        [NSObject exchangeInstanceMethodWithSelfClass:NSClassFromString(@"NSTaggedPointerString")
                                     originalSelector:NSSelectorFromString(tmpReplaceRangeOfStr)                                     swizzledSelector:NSSelectorFromString(tmpSafePointReplaceRangeOfStr)];
        
        // 替换 stringByAppendingString:
        NSString *tmpAppendingOfStr = @"stringByAppendingString:";
        NSString *tmpSafeAppendingOfStr = @"safe_stringByAppendingString:";
        NSString *tmpSafePointAppendingOfStr = @"safePoint_stringByAppendingString:";
        
        [NSObject exchangeInstanceMethodWithSelfClass:NSClassFromString(@"__NSCFConstantString")
                                     originalSelector:NSSelectorFromString(tmpAppendingOfStr)                                     swizzledSelector:NSSelectorFromString(tmpSafeAppendingOfStr)];
        
        [NSObject exchangeInstanceMethodWithSelfClass:NSClassFromString(@"NSTaggedPointerString")
                                     originalSelector:NSSelectorFromString(tmpAppendingOfStr)                                     swizzledSelector:NSSelectorFromString(tmpSafePointAppendingOfStr)];
...
- (NSString *)safePoint_stringByReplacingCharactersInRange:(NSRange)range withString:(NSString *)replacement
{
    ...
    return [self safePoint_stringByReplacingCharactersInRange:range withString:replacement];
}
...
- (NSString *)safePoint_stringByAppendingString:(NSString *)aString
{
    if (!aString) {
        return self;
    }
    
    return [self safePoint_stringByAppendingString:aString];
}
